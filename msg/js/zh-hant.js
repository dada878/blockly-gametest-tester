...
Blockly.Msg["LOGIC_BOOLEAN_TOOLTIP"] = "返回是或否。";
...
Blockly.Msg["LOGIC_TERNARY_IF_TRUE"] = "如果為是";
Blockly.Msg["LOGIC_TERNARY_TOOLTIP"] = "檢查「測試」中的條件。如果條件為是，將返回「如果為是」的值；否則，返回「如果為否」的值。";
...
Blockly.Msg["PROCEDURES_DEFNORETURN_PROCEDURE"] = "函式1";
...
Blockly.Msg["PROCEDURES_DEFRETURN_RETURN"] = "返回參數";
